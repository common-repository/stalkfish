...
use Stalkfish\Dependencies\League\CommonMark\GithubFlavoredMarkdownConverter;
use Stalkfish\Dependencies\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
use Stalkfish\Dependencies\Ramsey\Uuid\Generator\CombGenerator;
use Stalkfish\Dependencies\Ramsey\Uuid\Uuid;
use Stalkfish\Dependencies\Ramsey\Uuid\UuidFactory;
use Stalkfish\Dependencies\voku\helper\ASCII;
class Str
{
    use Macroable;
    /**
