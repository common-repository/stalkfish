 ...
 */
namespace Stalkfish\Dependencies\Symfony\Component\HttpFoundation\Session\Attribute;

\trigger_deprecation('symfony/http-foundation', '5.3', 'The "%s" class is deprecated.', NamespacedAttributeBag::class);
/**
