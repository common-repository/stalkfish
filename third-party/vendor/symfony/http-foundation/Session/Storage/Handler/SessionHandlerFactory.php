...
use Stalkfish\Dependencies\Doctrine\DBAL\DriverManager;
use Stalkfish\Dependencies\Symfony\Component\Cache\Adapter\AbstractAdapter;
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \Stalkfish\Dependencies\Predis\ClientInterface:
