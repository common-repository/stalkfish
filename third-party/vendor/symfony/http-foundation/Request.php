...
use Stalkfish\Dependencies\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use Stalkfish\Dependencies\Symfony\Component\HttpFoundation\Exception\JsonException;
use Stalkfish\Dependencies\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use Stalkfish\Dependencies\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
...
class Request
{
    ...
    public static function setTrustedProxies(array $proxies, int $trustedHeaderSet)
    {
        if (self::HEADER_X_FORWARDED_ALL === $trustedHeaderSet) {
            \trigger_deprecation('symfony/http-foundation', '5.2', 'The "HEADER_X_FORWARDED_ALL" constant is deprecated, use either "HEADER_X_FORWARDED_FOR | HEADER_X_FORWARDED_HOST | HEADER_X_FORWARDED_PORT | HEADER_X_FORWARDED_PROTO" or "HEADER_X_FORWARDED_AWS_ELB" or "HEADER_X_FORWARDED_TRAEFIK" constants instead.');
        }
