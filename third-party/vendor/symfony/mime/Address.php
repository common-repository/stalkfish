 ...
 */
namespace Stalkfish\Dependencies\Symfony\Component\Mime;

use Stalkfish\Dependencies\Egulias\EmailValidator\EmailValidator;
use Stalkfish\Dependencies\Egulias\EmailValidator\Validation\MessageIDValidation;
use Stalkfish\Dependencies\Egulias\EmailValidator\Validation\RFCValidation;
use Stalkfish\Dependencies\Symfony\Component\Mime\Encoder\IdnAddressEncoder;
use Stalkfish\Dependencies\Symfony\Component\Mime\Exception\InvalidArgumentException;
use Stalkfish\Dependencies\Symfony\Component\Mime\Exception\LogicException;
use Stalkfish\Dependencies\Symfony\Component\Mime\Exception\RfcComplianceException;
/**
...
final class Address
{
    ...
    {
        \trigger_deprecation('symfony/mime', '5.2', '"%s()" is deprecated, use "%s::create()" instead.', __METHOD__, __CLASS__);
