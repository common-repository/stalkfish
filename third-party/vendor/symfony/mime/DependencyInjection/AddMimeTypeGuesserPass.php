 ...
 */
namespace Stalkfish\Dependencies\Symfony\Component\Mime\DependencyInjection;

use Stalkfish\Dependencies\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use Stalkfish\Dependencies\Symfony\Component\DependencyInjection\ContainerBuilder;
use Stalkfish\Dependencies\Symfony\Component\DependencyInjection\Reference;
/**
...
class AddMimeTypeGuesserPass implements CompilerPassInterface
{
    ...
    {
        if (0 < \func_num_args()) {
            \trigger_deprecation('symfony/mime', '5.3', 'Configuring "%s" is deprecated.', __CLASS__);
        }
