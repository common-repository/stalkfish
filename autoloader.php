	...
	protected function load_mapped_file( $prefix, $relative_class ) {
		...
		foreach ( $this->prefixes[ $prefix ] as $base_dir ) {
			...
			if ( strpos( $relative_class, '/' ) !== false ) {
				$file_name      = strtolower( substr( $relative_class, strrpos( $relative_class, '/', -0 ) + 1 ) );
				$relative_class = substr_replace( $relative_class, $file_name, strrpos( $relative_class, '/', -0 ) + 1 );
